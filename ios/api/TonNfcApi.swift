...
class TonNfcApi {
    ...
    func isKeyForHmacExistAndReturnIntoCallback(serialNumber : String) {
    ...
    func selectKeyForHmacAndReturnIntoCallback(serialNumber : String) {
    ...
    func createKeyForHmac(password : String, commonSecret : String, serialNumber : String) {
    ...
    func deleteKeyForHmac(serialNumber : String)  {
    ...
    func getSault() {
        print("Start operation: getSault")
