...
import com.tonnfccard.api.*;
import com.tonnfccard.api.nfc.*;

import static com.tonnfccard.CallbackHelper.*;
...
public class NfcCardModule extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    public void getTonAppletState(final Promise promise) {
        cardCryptoNfcApi.selectTonWalletAppletAndGetTonAppletState(createNfcCallback(promise));
    }

    @ReactMethod
    public void getSerialNumber(final Promise promise) {
      cardActivationNfcApi.selectTonWalletAppletAndGetSerialNumber(createNfcCallback(promise));
    }
    ...
    @ReactMethod
    public void finishDeleteKeyFromKeyChainAfterInterruption(String keyHmac, final Promise promise) {
        cardKeyChainNfcApi.finishDeleteKeyFromKeyChainAfterInterruption(keyHmac, createNfcCallback(promise));
    }
